...
/// Stub pour les plateformes qui ne supportent pas Bluetooth (Linux, Web, etc.)
class BluetoothConnectionStub implements ConnectionInterface {
  @override
  ...
  Future<void> hostGame(Game game) async {
    throw UnsupportedError('Bluetooth non supporté sur cette plateforme');
  }
